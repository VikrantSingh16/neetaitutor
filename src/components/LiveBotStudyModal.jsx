...
const LiveBotStudyModal = ({ isOpen, onRequestClose,setStartedSession,setActiveTab }) => {
  const modalStyles = {
    content: {
      width: "80%",
      maxWidth: "600px",
  ...
  return (
    ...
    <p className='text-sm text-center font-semibold '>Please start the session from home</p>
    <h2 className='font-semibold text-base text-center mt-2'>Are you ready for a session?</h2>
    <div className='mt-4'>
...
export default LiveBotStudyModal;
